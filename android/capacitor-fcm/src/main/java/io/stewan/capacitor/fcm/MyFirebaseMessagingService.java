...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private final String PREFERENCE_FILE_KEY = "CapacitorStorage"; //
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Log.e("SUCCESS", "OnMessageReceived from CAPACITOR FIRED!");
...
//            str = str.substring(1, str.length() - 1);
            ...
            try {
                ...
                Log.e("ARRAY", temp.getString("object"));

                JSONArray res = new JSONArray(temp.getString("object"));
                ...
                Log.e("MSG_RECEIVED", this.messageReceived.toString());
